# MODEL1310110000: MODEL1310110000
...
`pip install git+https://github.com/biomodels/MODEL1310110000.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110000.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110000 as model`
...
The model of cerebellum cells in granular layer metabolism is derived from the
...
and identified by:
[MODEL1310110000](http://identifiers.org/biomodels.db/MODEL1310110000) .
